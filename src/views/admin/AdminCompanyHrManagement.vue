    ...
    <div>
        ...
        <div class="container">
            <div class="handle-box">
                ...
                <el-input v-model="query.companyHrName" placeholder="用户名" class="handle-input mr10"></el-input>
            ...
            <el-table :data="studentData" border class="table" ref="multipleTable"
                ...
                <!--手机号-->
                <el-table-column prop="companyHrTel" align="center" label="手机号"></el-table-column>
                <!--电子邮箱-->
                <el-table-column prop="companyHrEmail" align="center" label="电子邮箱"></el-table-column>
...
import {
    fetchCompanyHrAllLikeByAdmin,
    fetchUpdateCompanyHrDeletedByAdmin,
    getCompanyHrAllByAdmin
} from "../../api/index";
...
export default {
    ...
    setup() {
        ...
        // 获取表格数据
        const getData = () => {
            getCompanyHrAllByAdmin(query).then((res) => {
        ...
        // 查询操作
        const handleSearch = () => {
            fetchCompanyHrAllLikeByAdmin(query).then((res) =>{
                console.log(res.data);
                studentData.value = res.data;
            })
        };
        ...
        const saveEdit = () => {
            ElMessageBox.confirm("确定要通过吗？", "提示", {type: "warning",}).then(()=>{
                fetchUpdateCompanyHrDeletedByAdmin(form).then((res) => {
                    console.log(res)
                    if (res.code == 20031) {
